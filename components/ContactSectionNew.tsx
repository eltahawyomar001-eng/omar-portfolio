  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
        <span className="font-display text-[25vw] text-white/[0.02] whitespace-nowrap">
          HELLO
        </span>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 text-center">
        ...
        {/* Main heading */}
        <motion.h2
          className="font-display text-5xl md:text-7xl lg:text-8xl text-white font-light mb-8"
        ...
        {/* Description */}
        <motion.p
          className="text-white/40 text-lg max-w-xl mx-auto mb-12"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <a
            ...
            className="group inline-flex items-center gap-4 px-8 py-4 border border-white/20 rounded-full text-white hover:bg-white hover:text-black transition-all duration-500"
          >
